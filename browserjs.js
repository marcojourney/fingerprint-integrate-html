...
exports.getVisitorId = exports.getAttributes = exports.load = exports.prepareForSources = exports.hashComponents = exports.componentsToDebugString = exports.getHelloWorld = void 0;
...
function load(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, prepareForSources()
                    /**
...
function getVisitorId() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getAttributes()];
                case 1:
                    attributes = _a.sent();
                    result = makeLazyGetResult(attributes);
                    return [2 /*return*/, result === null || result === void 0 ? void 0 : result.visitorId];
            }
        });
    });
}
...
var ip_1 = __webpack_require__(72);
/**
...
exports.sources = {
    ...
    ip: ip_1.getIPAddress,
    geographic: ip_1.getGeographic
};
/**
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getGeographic = exports.getIPAddress = void 0;
...
function getGeographic() {
    return __awaiter(this, void 0, void 0, function () {
        var ip, result, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getIPAddress()];
                case 1:
                    ip = _a.sent();
                    return [4 /*yield*/, fetch('http://ip-api.com/json/' + ip)];
                case 2:
                    result = _a.sent();
                    return [4 /*yield*/, result.json()];
                case 3:
...
exports.getGeographic = getGeographic;
...
exports["default"] = { getAttributes: agent_1.getAttributes, getVisitorId: agent_1.getVisitorId };
